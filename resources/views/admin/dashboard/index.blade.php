                    ...
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="info-box shadow">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $countMahasiswa }} Mahasiswa</span>
                            </div>
                    ...
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="info-box shadow">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $countPemasukan }} Pemasukan</span>
                            </div>
                    ...
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="info-box shadow">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ $countPengeluaran }} Pengeluaran</span>
                            </div>
